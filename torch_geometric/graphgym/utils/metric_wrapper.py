...
from torchmetrics.functional.classification import (
    multilabel_accuracy as accuracy,
    multilabel_average_precision as average_precision,
    multilabel_confusion_matrix as confusion_matrix,
    multilabel_f1_score as f1_score,
    multilabel_precision_recall_curve as precision_recall_curve,
    multilabel_precision as precision,
    multilabel_recall as recall,
    multilabel_auroc as auroc,
)
